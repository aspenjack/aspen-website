...
-------------------------------- 
Utilizes D3, JavaScript, and Plotly to create an interactive dashboard displaying various visuals related to individual participant's belly button cultures.

![](biodiversity_dashboard.png)

# Others
For more projects, feel free to check out my various [github repositories](https://github.com/aspenjack?tab=repositories)